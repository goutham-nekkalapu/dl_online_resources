...
# vgg_mean = np.array([123.68, 116.779, 103.939], dtype=np.float32).reshape((3,1,1)) # for 'theano'  
...
class Vgg16():
    ...
    def __init__(self):
        # self.FILE_PATH = 'http://files.fast.ai/models/' #for 'theano'
    ...
    def create(self):
        ...
        # model.add(Lambda(vgg_preprocess, input_shape=(3,224,224), output_shape=(3,224,224)))  # for 'theano'
        ...
        # fname = 'vgg16.h5' # to download 'theano' trained model
